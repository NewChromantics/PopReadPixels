...
{
ANDROID_ABI=$1
$ANDROID_NDK/ndk-build -j$MAXCONCURRENTBUILDS NDK_DEBUG=0 NDK_PROJECT_PATH=$SOURCE_ROOT/PopReadPixels.Android/
...
SRC_PATH="PopReadPixels.Android/libs/$ANDROID_ABI/libPopReadPixels.so"
